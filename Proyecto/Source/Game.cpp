...
void CGame::CargandoObjetos()
{
	...
	jugandoFondo2 = new Sprite(&openGlImplement, "Jugando2", 0, 0);
...
void CGame::JugandoPintar(){
	...
	//animacion fondo jugando
//	jugandoFondo->TranslateXYDraw(200, 200);
//	jugandoFondo->TranslateXYZ(translate_nave_x, translate_nave_y, translate_nave_z);//570
////jugandoFondo->ScaleXY(300.f, 300.f);
//	jugandoFondo->RotateXYZ(rotate_nave_x, rotate_nave_y, rotate_nave_z);//=======



	jugandoFondo->Draw();
	jugandoFondo2->TranslateXYDraw(800, 800);
	////////////////////////////////////////
	jugandoFondo2->TranslateXYZ(translate_nave_x, translate_nave_y, translate_nave_z);//570
	jugandoFondo2->ScaleXYZ(100.f, 100.f, 100.f);
	jugandoFondo2->RotateXYZ(rotate_nave_x, rotate_nave_y, rotate_nave_z);
	jugandoFondo2->Draw();
	...
	////
	//nave->GetNaveObjeto()->ScaleXYZ(20.f, 20.f, 20.f);
	////
